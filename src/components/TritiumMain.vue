...
<template>
  <div style="position:sticky;z-index: -100;" class="sticky-top">
		<img src="/logos/logo_con_texto_banner_inkscape.svg" style="width: 100%" />
	</div>
	<button onclick="topFunction()" id="back_to_top_btn" title="Volver al inicio ^">Inicio</button>
	<header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			<a class="navbar-brand" href="./">TRITIUM</a>
			...
			<div class="collapse navbar-collapse align-right" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a class="nav-link" href="#contact_us">Contacto</a>
					</li>
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true"
						 aria-expanded="false">Servicios</a>
						<div class="dropdown-menu" aria-labelledby="dropdown01" data-toggle="collapse">
							<a class="dropdown-item" href="https://maps.com.sv/maps/covid_maps_sv">Mapas Covid El Salvador</a>
							<a class="dropdown-item" href="./#consulting">Consultoría y Asesoría</a>
							<a class="dropdown-item" href="./#development">Desarrollo e Implementación de Sistemas</a>
							<a class="dropdown-item" href="./#training">Capacitación</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item dropdown-toggle dropright" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true"
							 aria-expanded="false">Servicios por tecnologías</a>
							<div class="dropdown-menu dropright" aria-labelledby="dropdown02">
								<a class="dropdown-item" href="./#development_m4">Desarrollo Meta4</a>
								<a class="dropdown-item" href="./#development_oracle">Desarrollo Oracle</a>
								<a class="dropdown-item" href="./#development_java">Desarrollo Java</a>
								<a class="dropdown-item" href="./#development_js">NodeJS</a>
							</div>
						</div>
					</li>
				</ul>
	...
	<main role="main" class="bg-white">
		...
		<div id="myCarousel" class="d-none d-lg-block carousel slide carousel-fade" data-ride="carousel">
			...
			<div class="carousel-inner">
					...
					<div class="container">
						<div class="carousel-caption">
							...
							<p>Somos profesionales que brindamos consultoría informática en diversas áreas, principalmente en software de
								Recursos Humanos.</p>
							<p><a class="btn btn-lg btn-primary" href="#consulting" role="button">Saber mas</a></p>
						</div>
					</div>
				</div>
				...
				<div class="carousel-item">
					...
					<div class="container">
						<div class="carousel-caption">
							<h1>
                                <a href="https://maps.com.sv/maps/covid_maps_sv" role="button" style="color:white;">
                                    <img src="https://maps.com.sv/img/gif_covid_latest.gif" style="width:75px;height:75px;" /> Mapas<span class="d-none d-md-inline">
									-</span> Mapas Covid-19 El Salvador</a>
                            </h1>
							<p>Mapas Covid-19 Detallados por municipio El Salvador.</p>
							<p><a class="btn btn-lg btn-primary" href="https://maps.com.sv/maps/covid_maps_sv" role="button">Ir al sitio</a></p>
						</div>
					</div>
				</div>
				...
				<div class="carousel-item">
					...
					<div class="container">
						<div class="carousel-caption">
							...
							<p>Le apoyamos en el desarrollo, adaptación e implementación de software a la medida de las necesidades de su
								empresa.</p>
							<p><a class="btn btn-lg btn-primary" href="#development" role="button">Ver más</a></p>
						</div>
					</div>
				</div>
				<div class="carousel-item">
					...
					<div class="container">
						<div class="carousel-caption">
							<h1>Capacitación</h1>
							<p>Ofrecemos capacitación técnica y funcional para que pueda hacer mejor uso de sus productos.</p>
							<p><a class="btn btn-lg btn-primary" href="#training" role="button">Ver más</a></p>
						</div>
					</div>
				</div>
			</div>
	  ...
	  ================================================== -->
		...
		<div class="container marketing">
			...
			<a name="about" class="title">&nbsp;</a>
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					<h2 class="featurette-heading">TRITIUM Consultores</h2>
					<p class="lead"></p>
					<p>Bienvenido a TRITIUM, una consultora con experiencia en análisis, implementación y mantenimiento de
						proyectos informáticos principalmente orientados a Recursos Humanos.</p>
					<p>Tenemos presencia en varios países como Chile, Argentina y El Salvador. Nuestros
						clientes se encuentran en México, El Salvador, Chile y Argentina.</p>
					<p>Trabajamos con empresas de todo tamaño y con diversas tecnologías. Nos especializamos en integración de
						sistemas, software de Recursos
						Humanos y otros, principalmente con las siguientes tecnologías:</p>
					<ul class="styledlist">
						<li><a href="#development_m4">Meta4 PeopleNet­®</a></li>
						<li><a href="#development_java">Java</a></li>
						<li><a href="#development_oracle">Oracle</a></li>
						<li><a href="#development_js">NodeJS</a></li>
					</ul>
					Y muchas más, además de trabajar en la integración de sistemas.
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					<p class="lead">Nos dedicamos principalmente a asesorar empresas respecto a sus proyectos de software, así como a
						...
						apoyo sea orientado a las necesidades de su empresa y no a las de los demás. Si desea implementar algún producto
						de terceros como por ejemplo, Meta4 PeopleNet®, o si desea actualizar, adecuar o mejorar su instalación
						existente, nosotros podemos apoyarle ya sea brindándole asesoría u ofreciéndole soluciones alternativas a las que
						tendrían normalmente. Escríbanos!</p>
					<p class="disclaimer">Meta4 PeopleNet­® es una marca registrada de Meta4 Spain Sa <a href="https://www.meta4.es/">www.meta4.es</a>,
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					...
					<ul class="styledlist">
						<li>
							<strong><a class="title" name="development_m4">Meta4 PeopleNet­®</a></strong>
							<div>
								Desarrollo con herramientas PeopleNet®, Le apoyamos a mejorar, corregir y optimizar su instalación InHouse,
								trabajando con todas las herramientas que provee esta aplicación:
								<ul class="styledlist">
									<li>RH</li>
									<li>Nómina</li>
									<li>Autoservicio</li>
									<li>Reportes e interfaces</li>
								</ul>
								<p>Además de apoyarlo en migraciones desde y hacia esta herramienta, integración con otro software y más.</p>
						...
						<li>
							<strong><a class="title" name="development_oracle">Oracle</a></strong>
							<p>Desarrollo PL/SQL, optimización de procesos de aplicaciones, etc.</p>
						</li>
						<li>
							<strong><a class="title" name="development_java">Java</a></strong>
							<div>
								Desarrollos en el lenguaje Java, integración de aplicaciones Java con Meta4 PeopleNet®, Desarrollo de
								aplicaciones desde cero, etc.
							</div>
						</li>
						<li>
							<strong><a class="title" name="development_js">NodeJS / Javascript</a></strong>
							<p>Desarrollo FullStack con Javascript/HTML5/CSS, backend con NodeJS, mejora de aplicaciones existentes como el
								Autoservicio del empleado de Meta4® y otras.</p>
						</li>
					</ul>
				</div>
				<div class="col-md-5 order-md-1">
				...
				<div class="col-md-7">
					...
					<div id="carouselClients" class="carousel slide carousel-fade" data-ride="carousel">
							...
							<a class="carousel-control-prev" href="#carouselClients"  role="button" data-slide="prev">
								<span class="carousel-control-prev-icon" style="background-color: lightgrey;" aria-hidden="true"></span>
								<span class="sr-only" >Previous</span>
							</a>
							<a class="carousel-control-next" href="#carouselClients" role="button" data-slide="next">
								<span class="carousel-control-next-icon" style="background-color: lightgrey;"  aria-hidden="true"></span>
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ftritiumconsultores%2F&tabs=timeline%2Cmessages&width=340&height=350&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=1736418119708506"
					 width="340" height="350" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"
		...
		<footer class="container">
			...
			<p>&copy; 2017-2018 TRITIUM, S.p.A. &middot; <a href="privacy.html#spanish">Política de privacidad</a> &middot; <a
				 href="disclaimer.html#spanish">Términos y condiciones</a></p>
            Herramientas:<ul><li><a href="./diff-viewer/diffviewer.html">DiffViewer</a></li></ul>
			<p>Desarrollado por TRITIUM, S.p.A.</p>
		</footer>
	</main>
